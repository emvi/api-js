...
module.exports = class EmviClient {
	...
	refreshToken() {
		return new Promise((resolve, reject) => {
			...
			this.axios.post(this.auth_host+authenticationEndpoint, req)
			.then(r => {
	...
	findArticles(query, filter) {
		...
		return new Promise((resolve, reject) => {
			this.axios.get(this.api_host+searchArticlesEndpoint, {headers: this._config().headers, params: filter})
			.then(r => {
	...
	findLists(query, filter) {
		...
		return new Promise((resolve, reject) => {
			this.axios.get(this.api_host+searchListsEndpoint, {headers: this._config().headers, params: filter})
			.then(r => {
	...
	findTags(query, filter) {
		...
		return new Promise((resolve, reject) => {
			this.axios.get(this.api_host+searchTagsEndpoint, {headers: this._config().headers, params: filter})
			.then(r => {
	...
	findAll(query, filter) {
		...
		return new Promise((resolve, reject) => {
			this.axios.get(this.api_host+searchAllEndpoint, {headers: this._config().headers, params: filter})
			.then(r => {
				r.data.articles = r.data.articles || [];
	...
	getListEntries(id, langId, filter) {
		...
		return new Promise((resolve, reject) => {
			this.axios.get(this.api_host+listEntriesEndpoint.replace("{id}", id), {headers: this._config().headers, params: filter})
			.then(r => {
	...
	_addAxiosInterceptor() {
		this.axios.interceptors.response.use(null, e => {
